...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-800">
            <?php $hour = now()->hour; ?>
            Good <?php echo e($hour < 12 ? 'morning' : ($hour < 17 ? 'afternoon' : 'evening')); ?>, <?php echo e(explode(' ', auth()->user()->name)[0] ?? ''); ?>

        </h2>
        <p class="text-sm text-gray-400 mt-1">Term <?php echo e($currentTerm); ?>, <?php echo e($currentYear); ?> — here's what's happening at <?php echo e(config('school.name')); ?> today.</p>
    </div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($termEnd): ?>
    <div class="text-right shrink-0">
        <p class="text-xs text-gray-400 uppercase tracking-wide font-medium">Term Progress</p>
        <p class="text-lg font-bold text-gray-800"><?php echo e($daysLeftInTerm); ?> Days Left</p>
        <div class="w-40 h-2 bg-gray-100 rounded-full mt-1 overflow-hidden">
            <div class="h-full bg-green-600" style="width: <?php echo e($termProgressPercent ?? 0); ?>%"></div>
        </div>
    </div>
...
<div class="bg-blue-50 border border-blue-100 rounded-xl p-5 mb-6">
    ...
    <ul class="space-y-2">
        ...
        <li class="flex items-start gap-2 text-sm text-blue-900">
            <span class="mt-0.5">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($insight['icon']):
                    case ('warning'): ?> ⚠️ <?php break; ?>
                    <?php case ('trend_down'): ?> 📉 <?php break; ?>
                    <?php case ('trend_up'): ?> 📈 <?php break; ?>
                    <?php case ('people'): ?> 👥 <?php break; ?>
                    <?php case ('new'): ?> ✨ <?php break; ?>
                    <?php case ('assessment'): ?> 📋 <?php break; ?>
                    <?php case ('homework'): ?> 📝 <?php break; ?>
                    <?php case ('calendar'): ?> 📅 <?php break; ?>
                    <?php default: ?> ℹ️
                <?php endswitch; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </span>
            <span><?php echo e($insight['text']); ?></span>
        </li>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($totalLearners)); ?></p>
            <p class="text-xs text-green-600 mt-0.5"><?php echo e($totalClasses); ?> active classes</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($totalStaff)); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-900">KES <?php echo e(number_format($feesCollected)); ?></p>
            <p class="text-xs text-yellow-600 mt-0.5">Term <?php echo e(config('school.current_term')); ?>, <?php echo e(config('school.academic_year')); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-900">KES <?php echo e(number_format($feeArrears)); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => [$label, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-3 bg-<?php echo e($color); ?>-50 rounded-lg border border-<?php echo e($color); ?>-100">
                <div class="flex items-center justify-between mb-1">
                    <span class="text-xs font-bold text-<?php echo e($color); ?>-700 bg-<?php echo e($color); ?>-200 px-2 py-0.5 rounded"><?php echo e($code); ?></span>
                    <span class="text-lg font-bold text-<?php echo e($color); ?>-800"><?php echo e($rubricCounts[$code] ?? 0); ?></span>
                </div>
                <p class="text-xs text-<?php echo e($color); ?>-600 leading-tight"><?php echo e($label); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div class="mt-4 pt-3 border-t border-gray-100">
            <a href="<?php echo e(route('admin.reports.index')); ?>" class="text-xs text-green-700 font-medium hover:underline">View full assessment report →</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div class="grid grid-cols-2 gap-3">
            <a href="<?php echo e(route('admin.students.index')); ?>" class="flex flex-col items-center gap-2 p-3 rounded-lg bg-green-50 hover:bg-green-100 transition-colors text-center">
            ...
            <a href="<?php echo e(route('admin.assessment.index')); ?>" class="flex flex-col items-center gap-2 p-3 rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors text-center">
            ...
            <a href="<?php echo e(route('finance.payments.index')); ?>" class="flex flex-col items-center gap-2 p-3 rounded-lg bg-yellow-50 hover:bg-yellow-100 transition-colors text-center">
            ...
            <a href="<?php echo e(route('admin.reports.index')); ?>" class="flex flex-col items-center gap-2 p-3 rounded-lg bg-purple-50 hover:bg-purple-100 transition-colors text-center">
            ...
            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="flex flex-col items-center gap-2 p-3 rounded-lg bg-red-50 hover:bg-red-100 transition-colors text-center">
            ...
            <a href="<?php echo e(route('admin.kemis.index')); ?>" class="flex flex-col items-center gap-2 p-3 rounded-lg bg-teal-50 hover:bg-teal-100 transition-colors text-center">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between py-2 border-b border-gray-50">
                ...
                <span class="text-sm font-semibold text-gray-800"><?php echo e(config('school.academic_year')); ?></span>
            </div>
            <div class="flex items-center justify-between py-2 border-b border-gray-50">
                <span class="text-sm text-gray-500">Current Term</span>
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Term <?php echo e(config('school.current_term')); ?></span>
            </div>
            <div class="flex items-center justify-between py-2 border-b border-gray-50">
                <span class="text-sm text-gray-500">School Type</span>
                <span class="text-sm font-semibold text-gray-800 capitalize"><?php echo e(config('school.type', 'Primary')); ?></span>
            </div>
            <div class="flex items-center justify-between py-2 border-b border-gray-50">
                <span class="text-sm text-gray-500">Active Classes</span>
                <span class="text-sm font-semibold text-gray-800"><?php echo e($totalClasses); ?></span>
            </div>
        ...
        <div class="mt-4 pt-3 border-t border-gray-100">
            <div class="flex items-center gap-2 text-xs text-gray-400">
                ...
                Last updated: <?php echo e(now()->format('d M Y, H:i')); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('finance.payments.index')); ?>" class="text-xs text-green-700 font-medium hover:underline">View all</a>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentPayments->isEmpty()): ?>
            ...
            <div class="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center text-xs font-bold text-green-700">
                        <?php echo e(strtoupper(substr($payment->invoice->learner->full_name ?? 'U', 0, 1))); ?>

                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-800"><?php echo e($payment->invoice->learner->full_name ?? 'Unknown'); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($payment->created_at->format('d M Y')); ?></p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-sm font-semibold text-green-700">KES <?php echo e(number_format($payment->amount)); ?></p>
                    <p class="text-xs text-gray-400"><?php echo e($payment->payment_method?->label() ?? 'Cash'); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('admin.students.index')); ?>" class="text-xs text-green-700 font-medium hover:underline">View all</a>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentLearners->isEmpty()): ?>
        <div class="text-center py-8">
        ...
        <?php else: ?>
        <div class="space-y-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentLearners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $learner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-xs font-bold text-blue-700">
                        <?php echo e(strtoupper(substr($learner->full_name ?: 'L', 0, 1))); ?>

                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-800"><?php echo e($learner->full_name); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($learner->admission_number ?? 'N/A'); ?></p>
                    </div>
                </div>
                <div class="text-right">
                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
                        <?php echo e($learner->grade_level?->value ?? 'N/A'); ?>

                    </span>
                    <p class="text-xs text-gray-400 mt-0.5"><?php echo e($learner->created_at->format('d M')); ?></p>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div class="space-y-2">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between py-1.5">
                <span class="text-xs text-gray-600"><?php echo e($level); ?></span>
                <span class="text-xs font-semibold text-<?php echo e($color); ?>-700 bg-<?php echo e($color); ?>-50 px-2 py-0.5 rounded"><?php echo e($gradeBandCounts[$level] ?? 0); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div class="mt-4 pt-3 border-t border-gray-100">
            <a href="<?php echo e(route('admin.students.index')); ?>" class="text-xs text-green-700 font-medium hover:underline">View class breakdown →</a>
        </div>
    </div>
        ...
        <div class="space-y-3">
            <div>
                <div class="flex justify-between text-xs text-gray-500 mb-1">
                    <span>Collected</span>
                    <span>KES <?php echo e(number_format($feesCollected)); ?></span>
                </div>
                <div class="w-full bg-gray-100 rounded-full h-2">
                    <?php $total = $feesCollected + $feeArrears; $pct = $total > 0 ? ($feesCollected / $total) * 100 : 0; ?>
                    <div class="bg-green-500 h-2 rounded-full" style="width: <?php echo e($pct); ?>%"></div>
                </div>
            </div>
            <div>
                <div class="flex justify-between text-xs text-gray-500 mb-1">
                    <span>Outstanding</span>
                    <span>KES <?php echo e(number_format($feeArrears)); ?></span>
                </div>
                <div class="w-full bg-gray-100 rounded-full h-2">
                    <div class="bg-red-400 h-2 rounded-full" style="width: <?php echo e(100 - $pct); ?>%"></div>
                </div>
            </div>
        </div>
        <div class="mt-4 grid grid-cols-2 gap-3">
            <div class="bg-green-50 rounded-lg p-3 text-center">
                <p class="text-lg font-bold text-green-700"><?php echo e(number_format($pct, 1)); ?>%</p>
                <p class="text-xs text-green-600">Collection Rate</p>
            </div>
            <div class="bg-red-50 rounded-lg p-3 text-center">
                <p class="text-lg font-bold text-red-700"><?php echo e(number_format(100 - $pct, 1)); ?>%</p>
                <p class="text-xs text-red-600">Outstanding</p>
            </div>
        </div>
        <div class="mt-3 pt-3 border-t border-gray-100">
            <a href="<?php echo e(route('admin.reports.index')); ?>" class="text-xs text-green-700 font-medium hover:underline">View fee report →</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <div class="space-y-3">
            <div class="flex items-start gap-3 p-2.5 bg-yellow-50 rounded-lg border border-yellow-100">
                ...
                <div>
                    ...
                    <p class="text-xs text-yellow-600"><?php echo e($feeArrears > 0 ? 'Learners with outstanding balances' : 'No arrears'); ?></p>
                </div>
            </div>
            <div class="flex items-start gap-3 p-2.5 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <div>
                    ...
                    <p class="text-xs text-blue-600">
                        Last sync: <?php echo e($lastKemisSync?->started_at ? \Illuminate\Support\Carbon::parse($lastKemisSync->started_at)->diffForHumans() : 'Never'); ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastKemisSync): ?> (<?php echo e(ucfirst($lastKemisSync->status)); ?>) <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
                </div>
            </div>
        ...
        <div class="mt-4 pt-3 border-t border-gray-100">
            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="text-xs text-green-700 font-medium hover:underline">View all notifications →</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\elimums\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>