...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-green-900 flex flex-col flex-shrink-0">
        ...
        <div class="px-4 py-3 border-t border-green-800">
            <p class="text-green-300 text-xs"><?php echo e(auth()->user()->name); ?></p>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <header class="bg-white h-14 flex items-center px-6 shadow-sm flex-shrink-0 justify-between">
            <h1 class="text-lg font-semibold text-gray-800"><?php echo $__env->yieldContent('header', 'Dashboard'); ?></h1>
            <div class="flex items-center gap-3 text-sm text-gray-500">
                <span class="bg-green-100 text-green-800 px-2 py-0.5 rounded text-xs font-medium">
                    <?php echo e(config('school.current_academic_year')); ?> · Term <?php echo e(config('school.current_term')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\CBC school\resources\views/layouts/admin.blade.php ENDPATH**/ ?>