...
<head>
    ...
    <title>Login — <?php echo e(config('school.name')); ?></title>
...
<body class="bg-gradient-to-br from-green-900 to-green-700 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-white text-2xl font-bold"><?php echo e(config('school.name')); ?></h1>
            <p class="text-green-200 text-sm mt-1"><?php echo e(config('school.motto')); ?></p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-green-700 hover:text-green-800">Forgot password?</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <button type="submit"
        ...
        <p class="text-center text-green-300 text-xs mt-6">
            CBC School Management System &copy; <?php echo e(date('Y')); ?>

        </p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\CBC school\resources\views/auth/login.blade.php ENDPATH**/ ?>