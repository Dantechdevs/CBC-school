...
<div class="flex h-screen overflow-hidden">
        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-1">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="ml-8 mt-1 space-y-1">
                    <a href="{{ route('admin.students.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">All Learners</a>
                    <a href="{{ route('admin.students.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Enroll Learner</a>
                    <a href="{{ route('admin.students.import') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Import Learners</a>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="ml-8 mt-1 space-y-1">
                    <a href="{{ route('admin.assessment.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Enter Assessment</a>
                    <a href="{{ route('admin.reports.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Competency Tracker</a>
                    <a href="#" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Report Cards</a>
                    <a href="{{ route('admin.assessment.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Bulk Entry</a>
                    <a href="{{ route('admin.pathways.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Pathway Readiness</a>
                </div>
            </div>

            {{-- Homework --}}
            <a href="{{ route('admin.homework.index') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-green-100 hover:bg-green-700 {{ request()->routeIs('admin.homework.*') ? 'bg-green-700 font-semibold' : '' }}">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="ml-8 mt-1 space-y-1">
                    <a href="{{ route('admin.exams.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Exam Schedule</a>
                    <a href="#" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Question Bank</a>
                    <a href="{{ route('admin.exams.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Mark Entry</a>
                    <a href="{{ route('admin.exams.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Results</a>
                </div>
            </div>

            {{-- Inventory --}}
            <a href="{{ route('admin.inventory.index') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-green-100 hover:bg-green-700 {{ request()->routeIs('admin.inventory.*') ? 'bg-green-700 font-semibold' : '' }}">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="ml-8 mt-1 space-y-1">
                    ...
                    <a href="{{ route('admin.notes.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Learning Notes</a>
                </div>
            </div>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="ml-8 mt-1 space-y-1">
                    <a href="{{ route('admin.staff.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">All Staff</a>
            ...
            <a href="{{ route('admin.timetable.index') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-green-100 hover:bg-green-700 {{ request()->routeIs('admin.timetable.*') ? 'bg-green-700 font-semibold' : '' }}">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="ml-8 mt-1 space-y-1">
                    <a href="{{ route('admin.notifications.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Send SMS</a>
                    <a href="{{ route('admin.notifications.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Send Email</a>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" class="ml-8 mt-1 space-y-1">
                    <a href="{{ route('admin.reports.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Performance Reports</a>
                    <a href="{{ route('admin.reports.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Attendance Reports</a>
                    <a href="{{ route('admin.reports.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">Fee Reports</a>
                    <a href="#" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">BOG Reports</a>
                    <a href="{{ route('admin.kemis.index') }}" class="block px-3 py-2 text-sm text-green-200 hover:text-white hover:bg-green-700 rounded-lg">KEMIS Export</a>
                </div>
            </div>

            {{-- KEMIS Sync --}}
            <a href="{{ route('admin.kemis.index') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-green-100 hover:bg-green-700 {{ request()->routeIs('admin.kemis.*') ? 'bg-green-700 font-semibold' : '' }}">
            ...
            <a href="{{ route('admin.settings.index') }}"
               class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-green-100 hover:bg-green-700 {{ request()->routeIs('admin.settings.*') ? 'bg-green-700 font-semibold' : '' }}">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white h-14 flex items-center px-6 shadow-sm flex-shrink-0 justify-between">
            <h1 class="text-lg font-semibold text-gray-800">@yield('header', $header ?? 'Dashboard')</h1>
            <div class="flex items-center gap-3">

                {{-- Term Badge --}}
                <span class="bg-green-100 text-green-800 px-2 py-0.5 rounded text-xs font-medium">
                    {{ config('school.academic_year') }} · Term {{ config('school.current_term') }}
                </span>
                        ...
                        <div class="border-t border-gray-100 px-4 py-3">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="flex justify-between text-xs">
                                    ...
                                    <span class="font-medium text-gray-700">{{ config('school.academic_year') }}</span>
                                </div>
                            </div>
                        </div>
                        @endrole
